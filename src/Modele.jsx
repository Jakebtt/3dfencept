...
export function Model({ textureUrl }) {
  const group = useRef();
  const { nodes, materials } = useGLTF('/modele.glb');
  ...
  return (
    <group ref={group} position={[0, -3, 0]} scale={[2, 2, 2]} dispose={null}>
      <group name="Scene">
        ...
        <mesh name="Spacer003" geometry={nodes.Spacer003.geometry} material={materials['Material.001']} position={[-0.8, -0.096, 0.067]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        <mesh name="Spacer004" geometry={nodes.Spacer004.geometry} material={materials['Material.001']} position={[-0.8, -0.096, 0.068]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        ...
        <mesh name="Spacer009" geometry={nodes.Spacer009.geometry} material={materials['Material.001']} position={[-0.8, 0.166, 0.067]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        <mesh name="Spacer010" geometry={nodes.Spacer010.geometry} material={materials['Material.001']} position={[-0.8, 0.166, 0.068]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        ...
        <mesh name="Slat_1013" geometry={nodes.Slat_1013.geometry} material={materials['Material.004']} position={[-0.8, 1.036, 0.067]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.416]} />
        ...
        <mesh name="Spacer033" geometry={nodes.Spacer033.geometry} material={materials['Material.001']} position={[-0.8, 1.215, 0.067]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        <mesh name="Spacer034" geometry={nodes.Spacer034.geometry} material={materials['Material.001']} position={[-0.8, 1.215, 0.068]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        ...
        <mesh name="Spacer039" geometry={nodes.Spacer039.geometry} material={materials['Material.001']} position={[-0.8, 1.477, 0.067]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        <mesh name="Spacer040" geometry={nodes.Spacer040.geometry} material={materials['Material.001']} position={[-0.8, 1.477, 0.068]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        ...
        <mesh name="Spacer069" geometry={nodes.Spacer069.geometry} material={materials['Material.001']} position={[-0.8, -0.096, -1.801]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        <mesh name="Spacer070" geometry={nodes.Spacer070.geometry} material={materials['Material.001']} position={[-0.8, -0.096, -1.8]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        ...
        <mesh name="Spacer075" geometry={nodes.Spacer075.geometry} material={materials['Material.001']} position={[-0.8, 0.166, -1.801]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        <mesh name="Spacer076" geometry={nodes.Spacer076.geometry} material={materials['Material.001']} position={[-0.8, 0.166, -1.8]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        ...
        <mesh name="Slat_1045" geometry={nodes.Slat_1045.geometry} material={materials['Material.004']} position={[-0.8, 1.036, -1.801]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.416]} />
        ...
        <mesh name="Spacer099" geometry={nodes.Spacer099.geometry} material={materials['Material.001']} position={[-0.8, 1.215, -1.801]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        <mesh name="Spacer100" geometry={nodes.Spacer100.geometry} material={materials['Material.001']} position={[-0.8, 1.215, -1.8]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        ...
        <mesh name="Spacer105" geometry={nodes.Spacer105.geometry} material={materials['Material.001']} position={[-0.8, 1.477, -1.801]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        <mesh name="Spacer106" geometry={nodes.Spacer106.geometry} material={materials['Material.001']} position={[-0.8, 1.477, -1.8]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.886]} />
        ...
        <mesh name="Slat_1053" geometry={nodes.Slat_1053.geometry} material={materials['Material.004']} position={[-0.8, 1.736, -1.801]} rotation={[Math.PI / 2, 0, 0]} scale={[1, 1, 0.416]} />
      </group>
    </group>
  )
}
