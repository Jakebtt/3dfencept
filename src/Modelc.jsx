...
export function Model({ textureUrl }) {
  const group = useRef();
  const { nodes, materials } = useGLTF('/modelc.glb');
  ...
  return (
    <group ref={group} position={[0, -3, 0]} scale={[2, 2, 2]} dispose={null}>
      <group name="Scene">
        ...
        <group name="aEnd_Cap002" position={[-0.8, -1.034, -1.8]} rotation={[Math.PI / 2, 0, 0]}>
        ...
        <group name="aEnd_Cap001" position={[-0.8, -1.034, -1.8]} rotation={[Math.PI / 2, 0, 0]}>
        ...
        <group name="aEnd_Cap" position={[-0.8, -1.034, -1.8]} rotation={[Math.PI / 2, 0, 0]}>
